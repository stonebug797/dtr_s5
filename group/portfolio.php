...
?>
    ...
    <div id="portfolio introduce--<?=$groupname?>">
        ...
        <div id="portfolio_list_container">
            <div class="p-container-<?=$list_type?>">
        ...
        <div class="row">
            <div class="main-client__wrap">
                <ul class="main-client__list">
                    <li>
                        <img src="../images/img_client.png" class="desktop" alt="KB,신한카드,이노션,미래애셋,기아,SK텔레콤,코웨이,신세계,AIA,제일월드와이드">
                        <img src="../images/img_client_m.png" class="mobile mobile--inline" alt="KB,신한카드,이노션,미래애셋,기아,SK텔레콤,코웨이,신세계,AIA,제일월드와이드">
                    </li>
                    <li>
                        <img src="../images/img_client1.png" class="desktop" alt="KB,신한카드,이노션,미래애셋,기아,SK텔레콤,코웨이,신세계,AIA,제일월드와이드">
